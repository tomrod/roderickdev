...
Abbott's theory does appear to lack idiosyncratic market demand (e.g. a regulated industry or government agency may not allow AI workflows internally), but one would expect organizations in such situations would temporarily benefit from a surplus in labor supply capability. In fact, [it may be advantageous](https://www.ncsc.gov.uk/guidance/ai-and-cyber-security-what-you-need-to-know#:~:text=However%2C%20AI%20systems%20are%20subject%20to%20novel,need%20to%20be%20considered%20alongside%20standard%20cyber) to delay transitioning while other companies work out the "modernization" wrinkles (link points to UK NCSC on security considerations for AI tooling).
